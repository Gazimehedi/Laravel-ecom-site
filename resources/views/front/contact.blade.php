              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <div class="aa-contact-address-left">
                    <form class="comments-form contact-form" action="{{route('send_message')}}" method="post">@csrf
                     <div class="row">
                       <div class="col-md-6">
                ...
                <div class="col-md-4">
                  <div class="aa-contact-address-right">
                    <address>
                      <h4>@if (isset($setting->site_name)) {{$setting->site_name}} @else DailyShop @endif</h4>
                      <p>{{Str::limit($setting->description, 150)}}</p>
                      <p><span class="fa fa-home"></span>@if (isset($setting->address)) {{$setting->address}} @else Huntsville, AL 35813, USA. @endif</p>
                      <p><span class="fa fa-phone"></span>@if (isset($setting->mobile)) {{$setting->mobile}} @else + 021.343.7575 @endif</p>
                      <p><span class="fa fa-envelope"></span>Email: @if (isset($setting->email)) {{$setting->email}} @else support@dailyshop.com @endif</p>
                    </address>
                  </div>
                </div>
              </div>
